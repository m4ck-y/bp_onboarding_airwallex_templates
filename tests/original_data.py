...
VALUES(
    nextval('companies_id_company_seq'::regclass), 240, 7, 'BEATNORTH LLC', '384385483',
    '', 'completed/GREEN', '+525580008233', 'serviciosadmonycontrol@grupontemx.com', 'TEXAS',
    'HOUSTON','8588 KATY FREEWAY SUITE 435', '', '77024', 9,
...
INSERT INTO public.companies_manigo_relations(
    ...
    client_manigo_id)
VALUES(
    nextval('companies_manigo_relations_id_company_relation_seq'::regclass), currval('companies_id_company_seq'::regclass), 0, '1', 'acct_hV_DwqCVOrOk6aSzdz_WMA',
    'acct_hV_DwqCVOrOk6aSzdz_WMA', NULL, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,
    5);
...
VALUES(
    nextval('users_id_user_seq'::regclass), currval('companies_id_company_seq'::regclass), 139, 'JESUS', 'GOMEZ MARTINEZ',
    '+525543677677', true, true, 'completed/GREEN', false,
    false, NULL, 1, true, 2,
...
VALUES(
    nextval('users_info_id_user_info_seq'::regclass), currval('users_id_user_seq'::regclass), 'CIUDAD DE MEXICO', 'CIUDAD DE MEXICO', 'JAVIER BARROS SIERRA #540',
    '', '01210', 'CME');
...
VALUES(
    nextval('users_manigo_relations_id_user_relation_seq'::regclass), currval('users_id_user_seq'::regclass), NULL, 5, 'acct_hV_DwqCVOrOk6aSzdz_WMA', NULL,
    CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL, NULL, 'acct_hV_DwqCVOrOk6aSzdz_WMA', 'acct_hV_DwqCVOrOk6aSzdz_WMA');
...
VALUES(
    nextval('user_sessions_id_user_session_seq'::regclass), currval('users_id_user_seq'::regclass), 'serviciosadmonycontrol@grupontemx.com', '$2b$12$MyiF5Quj8F94jnx0AJbvaOyIq0K.kByAI61WqUC3wH1cIIsFotkDS', NULL,
